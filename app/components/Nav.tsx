...
export function Nav() {
    return (
        ...
        {/* <!-- Calendar --> */}
        <NavLink to={`/calendar/2024/${id}`} className="grid justify-center items-center">
            <div className="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
        ...
        {/* <!-- List --> */}
       <NavLink to={`/list/2024/${id}`} className="grid justify-center items-center">
            <div className="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
        ...
        {/* <!-- Dashboard --> */}
        <NavLink to={`/dashboard/2024/${id}`} className="grid justify-center items-center">
            <div className="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
